...
> **状态说明：本文件是上一阶段 M17 历史整改记录。当前有效的全量科学审计与一次性整改清单请执行 [`AI_SCIENCE_AUDIT_2026-08-23.md`](AI_SCIENCE_AUDIT_2026-08-23.md)，不要把本文件中已经关闭的问题当作当前未完成项。**
...
| F17-11 | 正则表达式黑名单被称为 Prompt Injection 防御与“安全沙盒校验” | 极易绕过；也没有权限、参数 schema、sandbox 或人工批准 | 降级为“工具级字符串过滤器”；补 threat model、允许列表、权限与执行隔离 |
