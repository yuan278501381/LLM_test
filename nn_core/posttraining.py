    ...
    return [
        {
            ...
            "sft": "量子纠缠是指两个或多个粒子之间存在的一种特殊关联。即便将它们分开到宇宙两端，测量其中一个的状态，另一个的状态也会瞬间确定。",
            "rlhf": "想象你有一双鞋，分别装进两个一模一样的盒子里。你把一个盒子寄到北京，另一个寄到纽约。在你打开北京盒子的那一瞬间，如果看到是左脚，你立刻100%知道纽约盒子里必定是右脚——即使两地相隔万里。在量子世界里，粒子就像这样心有灵犀，这种跨越距离的瞬间关联就叫量子纠缠。",
        },
        {
            "category": "编程任务构建",
