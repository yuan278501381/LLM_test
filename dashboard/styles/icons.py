...
def svg_icon(name: str, size: int = 16, color: str = "currentColor", extra_class: str = "") -> str:
    ...
    icons = {
        ...
        "step": '<line x1="19" x2="19" y1="5" y2="19"/><polygon points="5 4 15 12 5 20 5 4"/>',
    ...
    return (
        ...
        f'class="svg-icon {extra_class}" style="vertical-align: middle; display: inline-block;">{body}</svg>'
    )
